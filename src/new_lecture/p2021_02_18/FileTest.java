...
// 디렉토리 체제를 관리하는 클래스임.
// 게시판에 사용시 첨부파일 올린 글을 삭제할때 같이 삭제해주는 기능을 쓸때 사용함.
public class FileTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// test폴더가 생성됨
File temp = new File("C:/java01", "temp");//c:/java01(부모디렉토리) - temp (자식디렉토리)
File tempFile = new File("test");         // javapro (현재 프로젝트 최상위에 생성) - test
